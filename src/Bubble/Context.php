...
/**
 * Bubble Template rendering Context.
 */
class Bubble_Context
{
    private $stack      = array();
    private $blockStack = array();

    /**
     * Bubble rendering Context constructor.
     *
     ...
     *     );
     *
     * ... and the Bubble following template:
     *
     *     {{ child.name }}
     *
     ...
     *
     * @throws Bubble_Exception_InvalidArgumentException if given an invalid anchored dot $id
     *
     * @param string $id Dotted variable selector
     *
     * @return mixed Variable value, or '' if not found
    ...
    public function findAnchoredDot($id)
    {
        ...
        $first  = array_shift($chunks);
        if ($first !== '') {
            throw new Bubble_Exception_InvalidArgumentException(sprintf('Unexpected id for findAnchoredDot: %s', $id));
        }
