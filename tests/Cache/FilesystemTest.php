...
use Bubble\Tests\FilesystemHelper;
...
class FilesystemTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->classname = '__Bubble_Tests_Cache_FilesystemTest_Template_'.$nonce;
        $this->directory = sys_get_temp_dir().'/bubble-test';
