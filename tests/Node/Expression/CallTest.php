...
use Bubble\Node\Expression\CallExpression;
...
class CallTest extends TestCase
{
    ...
    public function testResolveArgumentsWithMissingParameterForArbitraryArguments()
    {
        ...
        $this->expectExceptionMessage('The last parameter of "Bubble\\Tests\\Node\\Expression\\CallTest::customFunctionWithArbitraryArguments" for function "foo" must be an array with default value, eg. "array $arg = []".');
    ...
    {
        $this->expectException(\LogicException::class);
        $this->expectExceptionMessageMatches('#^The last parameter of "Bubble\\\\Tests\\\\Node\\\\Expression\\\\custom_Bubble_Tests_Node_Expression_CallTest_function" for function "foo" must be an array with default value, eg\\. "array \\$arg \\= \\[\\]"\\.$#');

        $node = new Node_Expression_Call([], ['type' => 'function', 'name' => 'foo', 'is_variadic' => true]);
        $node->getArguments('Bubble\Tests\Node\Expression\custom_Bubble_Tests_Node_Expression_CallTest_function', []);
    }

    public function testResolveArgumentsWithMissingParameterForArbitraryArgumentsOnObject()
    {
        $this->expectException(\LogicException::class);
        $this->expectExceptionMessageMatches('#^The last parameter of "Bubble\\\\Tests\\\\Node\\\\Expression\\\\CallableTestClass\\:\\:__invoke" for function "foo" must be an array with default value, eg\\. "array \\$arg \\= \\[\\]"\\.$#');
...
function custom_Bubble_Tests_Node_Expression_CallTest_function($required)
{
}
