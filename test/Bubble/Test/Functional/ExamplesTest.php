 ...
 * @group functional
 */
class Bubble_Test_Functional_ExamplesTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testExamples($context, $source, $partials, $expected)
    {
        ...
        $this->assertEquals($expected, $bubble->loadTemplate($source)->render($context));
    }
     ...
     * three files: one Bubble class (.php), one Bubble template (.bubble), and one output file
