...
/**
 * A PHPUnit test case wrapping the Bubble Spec.
 *
 * @group bubble-spec
 * @group functional
 */
class Bubble_Test_FiveThree_Functional_BubbleSpecTest extends Bubble_Test_SpecTestCase
{
    /**
    ...
    public function testSpecInitialized()
    {
        if (!file_exists(dirname(__FILE__) . '/../../../../../vendor/spec/specs/')) {
            $this->markTestSkipped('Bubble spec submodule not initialized: run "git submodule update --init"');
        }
    }
