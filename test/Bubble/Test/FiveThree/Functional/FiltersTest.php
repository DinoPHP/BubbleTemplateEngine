 ...
 * @group functional
 */
class Bubble_Test_FiveThree_Functional_FiltersTest extends PHPUnit_Framework_TestCase
{
    private $bubble;
    ...
    {
        $this->bubble->setHelpers($helpers);
    ...
    {
        $tpl = $this->bubble->loadTemplate('{{% FILTERS }}{{ date | longdate | withbrackets }}');

        $this->bubble->addHelper('longdate', function (\DateTime $value) {
            return $value->format('Y-m-d h:m:s');
        });

        $this->bubble->addHelper('withbrackets', function ($value) {
...
EOS;
    ...
    {
        $tpl = $this->bubble->loadTemplate(self::CHAINED_SECTION_FILTERS_TPL);

        $this->bubble->addHelper('echo', function ($value) {
            return array($value, $value, $value);
        });

        $this->bubble->addHelper('with_index', function ($value) {
