...
class Bubble_Test_HelperCollectionTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        ...
        $helpers = new Bubble_HelperCollection(array(
            'foo' => $foo,
            'bar' => $bar,
        ));
    ...
    public function testAccessorsAndMutators()
    {
        ...
        $helpers = new Bubble_HelperCollection();
    ...
    public function testHelperCollectionIsntAfraidToThrowExceptions($helpers = array(), $actions = array(), $exception = null)
    {
        ...
        $helpers = new Bubble_HelperCollection($helpers);
