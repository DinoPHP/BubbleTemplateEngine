 ...
 * @group unit
 */
class Bubble_Test_ContextTest extends PHPUnit_Framework_TestCase
{
    public function testConstructor()
    {
        $one = new Bubble_Context();
        $this->assertSame('', $one->find('foo'));
        $this->assertSame('', $one->find('bar'));

        $two = new Bubble_Context(array(
            'foo' => 'FOO',
            'bar' => '<BAR>',
        ));
    ...
    public function testPushPopAndLast()
    {
        ...
        $dummy = new Bubble_Test_TestDummy();
        $context->push($dummy);
    ...
    {
        $access = new Bubble_Test_TestArrayAccess(array(
            'a' => array('b' => array('c' => 'see')),
            'b' => 'bee',
        ));

        $context = new Bubble_Context($access);
        $this->assertEquals('bee', $context->find('b'));
        $this->assertEquals('see', $context->findDot('a.b.c'));
    ...
    {
        $context = new Bubble_Context(new Bubble_Test_AllTheThings());
...
class Bubble_Test_TestArrayAccess implements ArrayAccess
{
...
class Bubble_Test_AllTheThings implements ArrayAccess
{
    public $foo  = 'fail';
    public $bar  = 'win';
    private $qux = 'fail';
